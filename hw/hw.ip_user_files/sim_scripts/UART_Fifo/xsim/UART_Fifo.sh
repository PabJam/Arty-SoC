...
#
# Script generated by Vivado on Thu Dec 04 16:58:40 +0100 2025
...
# script info
echo -e "UART_Fifo.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot UART_Fifo xil_defaultlib.UART_Fifo xil_defaultlib.glbl -log elaborate.log
}
