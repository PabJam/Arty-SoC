...
#
# Script generated by Vivado on Fri Nov 28 11:10:23 +0100 2025
...
#
# Usage        : Add_Sub.sh
#                Add_Sub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Add_Sub.sh [-reset_run]
#                Add_Sub.sh [-reset_log]
#                Add_Sub.sh [-help]
#
...
# script info
echo -e "Add_Sub.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Add_Sub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_20 -L secureip -L xpm --snapshot Add_Sub xil_defaultlib.Add_Sub -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Add_Sub.wdb xsim.dir libdpi.so)
...
Usage: Add_Sub.sh [-step]\n\
Usage: Add_Sub.sh [-lib_map_path]\n\
Usage: Add_Sub.sh [-reset_run]\n\
Usage: Add_Sub.sh [-reset_log]\n\
Usage: Add_Sub.sh [-keep_index]\n\
