...
#
# Script generated by Vivado on Tue Nov 11 15:50:27 +0100 2025
...
#
# Usage        : ProgRam.sh
#                ProgRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ProgRam.sh [-reset_run]
#                ProgRam.sh [-reset_log]
#                ProgRam.sh [-help]
#
...
# script info
echo -e "ProgRam.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ProgRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ProgRam xil_defaultlib.ProgRam xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ProgRam.wdb xsim.dir libdpi.so)
...
Usage: ProgRam.sh [-step]\n\
Usage: ProgRam.sh [-lib_map_path]\n\
Usage: ProgRam.sh [-reset_run]\n\
Usage: ProgRam.sh [-reset_log]\n\
Usage: ProgRam.sh [-keep_index]\n\
