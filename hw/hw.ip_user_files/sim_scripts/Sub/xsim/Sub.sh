...
#
# Script generated by Vivado on Fri Nov 28 10:56:45 +0100 2025
...
#
# Usage        : Sub.sh
#                Sub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Sub.sh [-reset_run]
#                Sub.sh [-reset_log]
#                Sub.sh [-help]
#
...
# script info
echo -e "Sub.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Sub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_20 -L secureip -L xpm --snapshot Sub xil_defaultlib.Sub -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Sub.wdb xsim.dir libdpi.so)
...
Usage: Sub.sh [-reset_log]\n\
Usage: Sub.sh [-keep_index]\n\
