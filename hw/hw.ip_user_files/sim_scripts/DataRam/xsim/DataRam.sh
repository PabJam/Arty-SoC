...
#
# Script generated by Vivado on Wed Nov 12 15:03:36 +0100 2025
...
# script info
echo -e "DataRam.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DataRam xil_defaultlib.DataRam xil_defaultlib.glbl -log elaborate.log
}
