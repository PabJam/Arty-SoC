...
riscv-none-elf-gcc.exe -march=rv32i -mabi=ilp32 -O2 -ffreestanding -nostdlib -c main.c -o main.o
...
REM Link both object files together
echo Linking...
riscv-none-elf-gcc.exe -march=rv32i -mabi=ilp32 -nostdlib -T linker.ld -o program.elf startup.o main.o
