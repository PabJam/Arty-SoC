...
synth_design -top Top_of_Arty_SoC -part xc7s25csga324-1 -directive FewerCarryChains -keep_equivalent_registers -resource_sharing off -no_lc
...
write_checkpoint -force -noxdef Top_of_Arty_SoC.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file Top_of_Arty_SoC_utilization_synth.rpt -pb Top_of_Arty_SoC_utilization_synth.pb"  } 
