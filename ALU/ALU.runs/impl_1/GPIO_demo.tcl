namespace eval ::optrace {
  variable script "D:/Projekte/Arty/ALU/ALU.runs/impl_1/GPIO_demo.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/Projekte/Arty/ALU/ALU.runs/synth_1/GPIO_demo.dcp
...
OPTRACE "link_design" START { }
  link_design -top GPIO_demo -part xc7s25csga324-1 
...
OPTRACE "phys_opt_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_timing_summary -max_paths 10 -report_unconstrained -warn_on_violation -file GPIO_demo_timing_summary_postroute_physopted.rpt -pb GPIO_demo_timing_summary_postroute_physopted.pb -rpx GPIO_demo_timing_summary_postroute_physopted.rpx" "report_bus_skew -warn_on_violation -file GPIO_demo_bus_skew_postroute_physopted.rpt -pb GPIO_demo_bus_skew_postroute_physopted.pb -rpx GPIO_demo_bus_skew_postroute_physopted.rpx"  }
  set_param project.isImplRun false
OPTRACE "phys_opt_design reports" END { }
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force GPIO_demo_postroute_physopt.dcp
