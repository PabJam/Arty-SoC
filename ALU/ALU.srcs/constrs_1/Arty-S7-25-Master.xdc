...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks -of_objects [get_ports CLK12MHZ]] -group [get_clocks -include_generated_clocks -of_objects [get_ports CLK100MHZ]]
